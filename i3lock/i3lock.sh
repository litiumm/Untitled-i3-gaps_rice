...
convert -scale 10% -blur 0x2 -resize 1000% "$tmpbg" "$tmpbg"
...
convert "$tmpbg" -font DejaVu-Sans-Mono-Book -fill white -pointsize 16 -draw "text 570,470 'Hi!! Type your password...'" "$icon" -gravity center -composite "$tmpbg"
